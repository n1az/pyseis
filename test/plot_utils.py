...
def plot_dem_with_stations(dem, dem_bounds, sta, sta_ids, filepath):
...
def plot_distance_matrix(matrix, sta_ids, filepath):
...
def plot_distance_maps(result, sta, sta_ids, dem_bounds, filepath):
...
def plot_amplitude_and_location(
    e,
    dem_bounds,
    sta,
    sta_ids,
