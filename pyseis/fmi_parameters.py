...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description='Create reference model reference parameter catalogue.')
    parser.add_argument(
        '--f-min',
        type=float,
        default=5,
        help='Lower boundary of the frequency range to be modeled')
    parser.add_argument(
        '--f-max',
        type=float,
        default=80,
        help='Upper boundary of the frequency range to be modeled')
