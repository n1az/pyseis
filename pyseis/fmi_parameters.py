...
def fmi_parameters(n, d_s, s_s, r_s, q_s, h_w, w_w, a_w, f_min, f_max, 
                   r_0, f_0, q_0, v_0, p_0, e_0, n_0_a, n_0_b, res):
    """
    ...
    pars_template = {
        'd_s': d_s, 's_s': s_s, 'r_s': r_s, 'q_s': q_s, 'w_w': w_w, 
        'a_w': a_w, 'h_w': h_w, 'f_min': f_min, 'f_max': f_max, 'r_0': r_0, 
        'f_0': f_0, 'q_0': q_0, 'v_0': v_0, 'p_0': p_0, 'e_0': e_0, 
        'n_0_a': n_0_a, 'n_0_b': n_0_b, 'res': res
    }
